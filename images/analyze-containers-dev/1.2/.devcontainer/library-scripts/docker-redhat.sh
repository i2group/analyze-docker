...
if microdnf list deltarpm >/dev/null 2>&1; then
  microdnf -y install deltarpm
fi

# Try to load os-release
. /etc/os-release 2>/dev/null

# If unable to load OS Name and Version from os-release, error
